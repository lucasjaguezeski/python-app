...
def get_db_session() -> AsyncSession:
    ...
    try:
        ...
        raise Exception("Não há uma sessão conectada para a operação (O contexto perdeu a session).")
...
class DatabaseManager:
    ...
    async def connect(self):
        ...
        try:
            ...
            self._session_factory = async_sessionmaker(autocommit=False, autoflush=False, bind=self.engine)
